                  ...
                  <div class="modal-body">
                    <form id="theForm" name="theForm" class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="satuan_material" id="satuan_material" class="form-control">
                      </div>
            ...
            <script type="text/javascript">
             $(function () {
              ...
              var table = $('#dataTableExample').DataTable({
                ...
                serverSide: true,
                paging: true,
                ajax: "{{ route('admin.master.material.satuan-material.index') }}",
                columns: [
                  {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                  {data: 'satuan_material', name: 'satuan_material'},
                  {
              ...
              $('body').on('click', '.edit-data', function () {
                var id = $(this).data('id');
                $.get("{{ route('admin.master.material.satuan-material.index') }}" +'/' + id + '', function (data) {
                  $('#theModalHeading').html("Edit Satuan Material");
                  $('#saveBtn').val("save");
                  $('#id').val(data.id);
                  $('#satuan_material').val(data.satuan_material);
                  $('#theModal').modal('show');
                })
              });
              ...
              $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                  ...
                  url: "{{ route('admin.master.material.satuan-material.store') }}",
                  type: "POST",
                  dataType: 'json',
              ...
              $('body').on('click', '.delete-data', function () {
                var id = $(this).data('id');
                $.get("{{ route('admin.master.material.satuan-material.index') }}" +'/' + id + '', function (data) {
                  $('#theModalDeleteHeading').html("Hapus Satuan Material");
                  $('#saveDeteleBtn').val("delete");
                  $('#id_delete').val(data.id);
                  $('#name_delete').html(data.satuan_material);
              ...
              $('#saveDeteleBtn').click(function (e) {
                ...
                $.ajax({
                  type: "DELETE",
                  url: "{{ route('admin.master.material.satuan-material.store') }}"+'/'+id,
                  success: function (data) {
                    table.draw();
